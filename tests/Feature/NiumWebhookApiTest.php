...
class NiumWebhookApiTest extends TestCase
{
    ...
    public function test_completed_template_with_only_system_reference_creates_completed_transaction(): void
    {
        ...
        $this->assertSame('COMPLETED', $freshTransfer->provider_status);
