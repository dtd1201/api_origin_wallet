...
<head>
    ...
    <title>Origin Wallet login verification code</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background-color:#ffffff;border-radius:16px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">
                                Use the verification code below to complete your Origin Wallet login.
                            </p>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#6b7280;">
                                If you did not try to log in, please ignore this email and change your password if needed.
                            </p>
                        </td>
                    </tr>
                </table>
