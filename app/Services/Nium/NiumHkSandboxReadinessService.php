...
final class NiumHkSandboxReadinessService
{
    public function report(UserProviderAccount $account): array
    {
        ...
        $rfiStarted = in_array($account->rfi_status, ['requested', 'action_required', 'responded', 'cleared'], true);
        ...
        return [
            ...
            'customer_rfi' => $rfiStarted ? $this->state($account->rfi_status === 'cleared', true, 'outstanding_or_unresolved') : ['status' => 'NOT_STARTED', 'blockers' => []],
