...
return [
    ...
    'nium' => [
        ...
        'client_name' => env('NIUM_CLIENT_NAME'),
        'regulatory_region' => env('NIUM_REGULATORY_REGION'),
        ...
        'beneficiary_requirements_cache_seconds' => env('NIUM_BENEFICIARY_REQUIREMENTS_CACHE_SECONDS', 3600),
        ...
        'beneficiary_delete_enabled' => env('NIUM_BENEFICIARY_DELETE_ENABLED', false),
        'account_verification_enabled' => env('NIUM_ACCOUNT_VERIFICATION_ENABLED', false),
        ...
        'transaction_rfi_fetch_endpoint' => env('NIUM_TRANSACTION_RFI_FETCH_ENDPOINT', '/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/transactions'),
        'transaction_rfi_response_endpoint' => env('NIUM_TRANSACTION_RFI_RESPONSE_ENDPOINT', '/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/transactions/{authCode}/rfi/upload'),
        'customer_rfi_response_method' => env('NIUM_CUSTOMER_RFI_RESPONSE_METHOD'),
        'customer_rfi_request_schema_version' => env('NIUM_CUSTOMER_RFI_REQUEST_SCHEMA_VERSION'),
        'customer_rfi_response_contract_version' => env('NIUM_CUSTOMER_RFI_RESPONSE_CONTRACT_VERSION'),
        'transaction_rfi_response_method' => env('NIUM_TRANSACTION_RFI_RESPONSE_METHOD', 'POST'),
        'transaction_rfi_request_schema_version' => env('NIUM_TRANSACTION_RFI_REQUEST_SCHEMA_VERSION'),
        'transaction_rfi_response_contract_version' => env('NIUM_TRANSACTION_RFI_RESPONSE_CONTRACT_VERSION'),
        'hk_van_allocation_mode' => env('NIUM_HK_VAN_ALLOCATION_MODE'),
        'hk_payment_id_currency' => env('NIUM_HK_PAYMENT_ID_CURRENCY'),
        'hk_payment_id_bank_name' => env('NIUM_HK_PAYMENT_ID_BANK_NAME'),
        'hk_payment_id_account_category' => env('NIUM_HK_PAYMENT_ID_ACCOUNT_CATEGORY'),
    ],
