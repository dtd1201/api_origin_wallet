...
return [
    ...
    'nium' => [
        ...
        'payment_ids_endpoint' => env('NIUM_PAYMENT_IDS_ENDPOINT', '/api/v2/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/paymentIds'),
        ...
        'payout_fx_enabled' => env('NIUM_PAYOUT_FX_ENABLED', false),
        'wallet_fx_enabled' => env('NIUM_WALLET_FX_ENABLED', false),
        'payout_fx_lock_endpoint' => env('NIUM_PAYOUT_FX_LOCK_ENDPOINT', '/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/lockExchangeRate'),
        'quote_endpoint' => env('NIUM_QUOTE_ENDPOINT', '/api/v1/client/{clientHashId}/quotes'),
        'quote_fetch_endpoint' => env('NIUM_QUOTE_FETCH_ENDPOINT', '/api/v1/client/{clientHashId}/quotes/{quoteId}'),
        'conversion_endpoint' => env('NIUM_CONVERSION_ENDPOINT', '/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/conversions'),
        ...
        'purpose_codes_cache_seconds' => (int) env('NIUM_PURPOSE_CODES_CACHE_SECONDS', 3600),
        ...
        'customer_rfi_response_endpoint' => env('NIUM_CUSTOMER_RFI_RESPONSE_ENDPOINT', '/api/v1/client/{clientHashId}/corporate/rfi'),
        ...
        'customer_rfi_response_method' => env('NIUM_CUSTOMER_RFI_RESPONSE_METHOD', 'POST'),
