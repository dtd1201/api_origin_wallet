...
return [
    ...
    'nium' => [
        ...
        'client_details_endpoint' => env('NIUM_CLIENT_DETAILS_ENDPOINT', '/api/v1/client/{clientHashId}'),
        ...
        'virtual_account_details_endpoint' => env('NIUM_VIRTUAL_ACCOUNT_DETAILS_ENDPOINT', '/api/v2/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/paymentIds'),
